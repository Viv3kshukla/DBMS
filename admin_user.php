  			...
  			<div class="container-fluid">
    			...
    			<ul class="nav navbar-nav">
     				<li class="active"><a href="main_page.php"><span class="glyphicon glyphicon-home"></span> &nbsp;Home </a></li>
      				<li><a href="admin_acc.php">Account </a></li>
      				<li><a href="admin_user.php">User </a></li>
      				<li><a href="admin_loan.php">Apply for loan</a></li>
      				<li><a href="admin_loan.php">Loan details</a></li>
      				<li><a href="admin_transaction.php">Transaction Page</a></li>
      				<li><a href="adminmini.php">Mini Statement</a></li>
    			</ul>
